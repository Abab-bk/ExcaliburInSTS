...
import ExcaliburInSTS.cards.Defend;
import ExcaliburInSTS.cards.Strike;
import ExcaliburInSTS.relics.SwordsmanshipRelic;

import java.util.ArrayList;

import static ExcaliburInSTS.CharacterFile.Enums.ExcaliburColor;
import static ExcaliburInSTS.ModFile.*;
...
public class CharacterFile extends CustomPlayer {
    ...
    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(SwordsmanshipRelic.ID);
        return retVal;
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass Excalibur;
        @SpireEnum(name = "TODO_COLOR")
        public static AbstractCard.CardColor ExcaliburColor;
        @SpireEnum(name = "TODO_COLOR")
