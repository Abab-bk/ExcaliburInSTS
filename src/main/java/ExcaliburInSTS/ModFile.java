...
import ExcaliburInSTS.cards.AbstractEasyCard;
import ExcaliburInSTS.cards.cardvars.AbstractEasyDynamicVariable;
import ExcaliburInSTS.potions.AbstractEasyPotion;
import ExcaliburInSTS.relics.AbstractEasyRelic;
import ExcaliburInSTS.util.ProAudio;
...
public class ModFile implements
    ...
    public static final String modID = "Flower.ExcaliburInSTS"; //TODO: Change this.
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.ExcaliburColor, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.Excalibur),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.Excalibur);
