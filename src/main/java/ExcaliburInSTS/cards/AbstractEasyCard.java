...
import ExcaliburInSTS.util.CardArtRoller;

import static ExcaliburInSTS.ModFile.makeImagePath;
import static ExcaliburInSTS.ModFile.modID;
import static ExcaliburInSTS.util.Wiz.*;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, CharacterFile.Enums.ExcaliburColor);
    }
